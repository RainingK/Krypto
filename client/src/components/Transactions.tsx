...
const TransactionCard = ( { addressTo, addressFrom, timestamp, message, amount, url, keyword }: IProps ): JSX.Element => {
	const keyward2 = keyword!
	const gifURL = useFetch( { keyword: keyward2 } );
